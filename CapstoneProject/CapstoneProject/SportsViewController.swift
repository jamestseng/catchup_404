...
class SportsViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    let items = ["None", "Try New Sports", "I like to Watch", "Basketball", "Hike", "Dance", "Swimming", "Baseball", "Soccer", "Bowling", "Golf",  "Football", "Ultimate Frisbee", "Water Sports", "Snow Sports" ]
